...
function Collections() {
  ...
  return (
    <div className='w-[98.9vw] min-h-[100vh] bg-gradient-to-r from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]'>
