...
function Cart() {
  ...
  return (
    <div className='w-[98.9vw] min-h-[100vh] p-[20px] overflow-hidden bg-gradient-to-r from-[#141414] to-[#0c2025]'>
          ...
          cartData.map((item,index)=>{
            ...
            return (
                <div key={index} className='w-[100%] h-[10%] border-t border-b'>
                  <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[7px] rounded-2xl relative'>
                    <img className='w-[100px] h-[100px] rounded-md' src={productData.image1} alt=""/>
                     <div className='flex items-start justify-center flex-col gap-[10px]'>
                      ...
                      <div className='flex items-center gap-[10px]'>
                        ...
                        <p className='w-[40px] h-[40px] text-[18px] text-[white] bg-[#518080b4] rounded-md mt-[5px] flex items-center justify-center border-[1px] border-[#9ff9f9]'>{item.size}</p>
                     </div>
                  </div>
                  <input type='number' min={1} defaultValue={item.quantity} className='md:max-w-20 max-w-10 md:px-2 md:py-2 py-[5px] px-[5px] text-[white] text-[18px]  font-semibold bg-[#518080b4] absolute md:top-[20%] top-[46%] left-[75%] md:left-[50%] border-[1px] border-[#9ff9f9] rounded-md' 
